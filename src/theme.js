(function () {
  ...
  function renderPanel(panel) {
    ...
    panel.innerHTML =
      ...
      '<button data-action="theme" data-val="light"' +
      (theme === 'light' ? ' class="on"' : '') +
      '>Light</button>' +
      '<button data-action="theme" data-val="dark"' +
      (theme === 'dark' ? ' class="on"' : '') +
      '>Dark</button>' +
      '</div>' +
      '</div>' +
      ...
      ACCENTS.map(function (a) {
        return (
          '<button class="tweaks-swatch' +
          (accent === a.id ? ' on' : '') +
          '"' +
          ' data-action="accent" data-val="' +
          a.id +
          '"' +
          ' title="' +
          a.label +
