  ...
  pages.forEach((pg, idx) => {
    ...
    tile.innerHTML = `
      ...
      <div class="pg-actions">
        <button class="btn-icon ghost pg-rotate-btn" title="Rotate 90° clockwise" aria-label="Rotate page ${idx + 1} clockwise"><svg class="icon" aria-hidden="true"><use href="#icon-rotate-cw"/></svg></button>
        <button class="btn-icon danger pg-delete-btn" title="Delete this page" aria-label="Delete page ${idx + 1}"${pages.length <= 1 ? ' disabled' : ''}><svg class="icon" aria-hidden="true"><use href="#icon-x"/></svg></button>
      </div>
      <div class="pg-arrow-btns">
        <button class="btn-icon ghost pg-up-btn" title="Move up" aria-label="Move page ${idx + 1} up"${idx === 0 ? ' disabled' : ''}><svg class="icon" aria-hidden="true"><use href="#icon-arrow-up"/></svg></button>
